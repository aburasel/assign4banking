...
$result = $customerRepo->viewTransactions($customer->getEmail());
?>
      ...
      <header class="py-10">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <h1 class="text-3xl font-bold tracking-tight text-white">
            Howdy, <?php echo $_SESSION['user_name'];
                    ?> 👋
          </h1>
        </div>
      </header>
                    ...
                    <tbody class="divide-y divide-gray-200 bg-white">
                      ...
                      ?>
                          <tr>
                            ...
                            $amount = "+$" . $res['amount'];
                            if ($res['transaction_type'] == TransactionType::WITHDRAW->value) {
                              $class = "text-red-600";
                              $amount = "-$" . $res['amount'];
                            }
