...
$customers = $adminRepo->viewCustomers();
?>
                  ...
                  <ul role="list" class="divide-y divide-gray-100">
                    ...
                    if ($customers) {
                      foreach ($customers as $key => $customer) {
                        ...
                        $avatarColor=Colors::COLORS[$key%6];
                    ...
                    ?>
                        <li class="relative flex justify-between px-4 py-5 gap-x-6 hover:bg-gray-50 sm:px-6 lg:px-8">
                          ...
                          alt="Al Nahian" /> -->
                            <span class="inline-flex items-center justify-center w-12 h-12 rounded-full <?php echo $avatarColor; ?>">
                              <span class="text-xl font-medium leading-none text-white"><?php echo $nameInitials; ?> </span>
                            </span>

                            <div class="flex-auto min-w-0">
                              <p class="text-sm font-semibold leading-6 text-gray-900">
                                <a href="./transactions.php?email=<?php echo $email; ?>">
                                  <span class="absolute inset-x-0 bottom-0 -top-px"></span>
                                  <?php echo $name; ?>
                                </a>
                              </p>
                              <p class="flex mt-1 text-xs leading-5 text-gray-500">
                                <a href="./transactions.php?email=<?php echo $email; ?>" class="relative truncate hover:underline"><?php echo $email; ?></a>
                              </p>
                            </div>
                          </div>
                        </li>
