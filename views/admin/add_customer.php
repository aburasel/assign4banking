...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  if (isset($_POST['first-name']) && isset($_POST['last-name']) && isset($_POST['email']) && isset($_POST['password'])) {
    ...
    $newCustomer = new Customer("$firstName $lastName", $email, password_hash($password, PASSWORD_DEFAULT));
    //$newUser->setAcces
    $user = $authentication->register($newCustomer);
    ...
    <div class="pb-32 bg-sky-600">
      ...
      <header class="py-10">
        <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          ...
          <h6 class="text-1xl font-bold tracking-tight text-white"><?php
    ...
    <main class="-mt-32">
      <div class="px-4 pb-12 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="bg-white rounded-lg">
          <form action="" method="POST" class="bg-white shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl md:col-span-2">
